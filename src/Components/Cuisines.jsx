    ...
    <div className="my-12">
      {isPureVeg ? (
        <h4 className="font-light text-[#535665] flex items-center mt-4">
          <svg className="fill-[#008000]" width="16" height="16" viewBox="0 0 512 512" style={{marginRight: 8+"px"}}>
        ...
        <label>
          <Toggle className="relative"
            ...
            icons={{
              checked: (
                <svg className="absolute top-0 bottom-0 m-auto" viewBox="0 0 512 512">
                  <path
                    fill="#ffffff"
